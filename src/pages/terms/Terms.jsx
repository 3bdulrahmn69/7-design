      ...
      >
        ...
        <main>
          ...
          <section aria-labelledby="revision-policy" className="mb-8">
            <h2
              id="revision-policy"
              className="text-2xl font-semibold bg-gradient-to-t from-[#FF7B00] via-[#FFDA00] to-[#FFE48B] bg-clip-text text-transparent mb-4"
            >
          ...
          <section aria-labelledby="contact-info" className="mb-8">
            ...
            <p className="text-lg mb-2">
              <span className="bg-gradient-to-t from-[#FF7B00] via-[#FFDA00] to-[#FFE48B] bg-clip-text text-transparent font-semibold">
