  ...
  return (
    <div className="grid-bg min-h-screen bg-primaryLightWhite text-primaryDarkBlack dark:bg-primaryDarkBlack dark:text-primaryLightWhite flex items-center justify-center overflow-hidden">
      <div className="text-center space-y-10 px-6">
        ...
        >
          <span className="absolute -top-2 -right-4 rotate-45 border-l-[24px] border-l-transparent border-r-[24px] border-r-transparent border-b-[24px] border-b-yellow-400 transition-transform transform duration-300 group-hover:scale-150"></span>
