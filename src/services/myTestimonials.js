export const myTestimonialsOne = [
  {
    name: 'Sahar Diab',
    title: 'Dega logo - Owner of Dega Printing & Design Brand',
    description:
  ...
  {
    name: 'Gadfar AlKazaz',
    title: 'Insan Foundation logo - Founder of Insan Foundation',
    description:
      'As an author of a children’s editorial, I had the honor of collaborating with Seven for the cover design of one of my books. Your professionalism, creativity, and punctuality exceeded my expectations. You treated me with patience and respect throughout the process, and the final result was beyond incredible. I highly recommend your agency to anyone looking to succeed in their business.',
  },
  {
    name: 'Ahmed Torgman',
    title: 'Shuts Café logo - Owner of Shuts Café',
    description:
  ...
  },
  {
    ...
    title: 'Parfino Oud logo - Owner of Parfino Oud',
    description:
  ...
  },
  {
    ...
    title: 'Joy Life logo - Marketing Manager at Joylife Cosmetics',
    description:
      'Before working with your team, we had a terrible experience with another design agency. They didn’t understand our vision, and the designs they delivered were far from what we wanted. But your team? Mashallah, you blew us away! You took the time to understand our brand and created packaging that’s not only beautiful but also uniquely us. Our customers love it, and so do we. Shukran for saving our brand!',
  },
  {
    name: 'Dr. Walid Al-Harbi',
    title: "Wali Al Ahd logo - Owner of Wali Al Ahd Women's Health Center",
    description:
...
export const myTestimonialsTwo = [
  {
    name: 'Tasbeeh El Masry',
    title:
      'Simplicity logo - Creative Director at Simplicity Saudi Arabian Clothing Store',
    description:
      'We tried working with another company before, but it was a complete disaster. They didn’t deliver on time, and the designs were generic and uninspired. Then we found your team, and it was like night and day! You understood our vision perfectly and created a brand identity that’s modern yet deeply rooted in our Saudi heritage. Alhamdulillah, the response from our customers has been amazing. You guys are true professionals!',
  },
  {
    name: 'Serag El-Din Talaat',
    title: 'Al Serag logo - Lawyer',
    description:
  ...
  },
  {
    ...
    title: 'Fly 60 logo - CEO of Fly 60 Airplane Company',
    description:
  ...
  },
  {
    ...
    title: 'Turbo Traders logo - CEO of Turbo Traders (Canada)',
    description:
      'Honestly, we had a bad experience with a previous design team. Their 3D designs were low quality and didn’t reflect our products well. But your team? You completely transformed how we showcase our products! The level of detail and realism is mind-blowing, and our sales have skyrocketed since we started using your designs. Your professionalism and creativity have been a huge part of our success. Thank you for your outstanding work!',
  },
  {
    name: 'Dr. Omar Al-Ghamdi',
    title: 'Mega Pharma logo - Pharmacist & Owner of Mega Pharma',
    description:
  ...
  },
  {
    ...
    title: 'Amalia logo - Brand Manager at Amalia Olive Oil Products',
    description:
